...
const STANDARD_RELATIONSHIPS: Record<string, string[]> = {
  Phone: ['CALLS', 'SMS', 'USES_DEVICE', 'USES_SIM', 'CONNECTS_VIA_IP', 'LOCATED_AT', 'RESOLVED_TO', 'COMMUNICATED_WITH'],
  SIMCard: ['USES_SIM', 'RESOLVED_TO', 'ASSOCIATED_WITH'],
  Device: ['USES_DEVICE', 'USED_DEVICE', 'CONNECTS_VIA_IP', 'LOCATED_AT', 'ASSOCIATED_WITH'],
  BankAccount: ['TRANSFERS_MONEY', 'TRANSACTED_WITH', 'RESOLVED_TO', 'OWNS_ACCOUNT'],
  IPAddress: ['CONNECTS_VIA_IP', 'ASSIGNED_IP', 'LOGGED_IN_FROM'],
  CellTower: ['LOCATED_AT', 'PINGED_TOWER'],
  Person: ['RESOLVED_TO', 'OWNS_PHONE', 'OWNS_ACCOUNT', 'CO_OFFENDING', 'ASSOCIATED_WITH'],
  SocialAccount: ['USES_HANDLE', 'RESOLVED_TO', 'ASSOCIATED_WITH'],
  ATM: ['TRANSACTED_AT', 'LOCATED_AT']
};
